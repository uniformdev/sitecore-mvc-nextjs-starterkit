...
module.exports = function() {
    ...
    process.env.UNIFORM_API_URL = process.env.UNIFORM_API_URL || 'http://habitat.local'
    process.env.UNIFORM_DATA_URL = process.env.UNIFORM_DATA_URL || 'http://habitat.local'
